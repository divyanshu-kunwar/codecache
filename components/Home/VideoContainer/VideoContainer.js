  ...
  return (
    ...
    >
      <div
        className={
          props.Type === "shorts"
            ? styles.imageShortsContainer
            : styles.imageSeriesContainer
        }
      >
        {props.Type === "shorts" && (
          <Image
      ...
      <div
        className={
          props.Type == "tools" ? styles.displayNone : styles.seriesStats
        }
      >
        <div
          className={
            props.Type === "shorts"
              ? styles.shortTimeStats
              : styles.playtimeStats
          }
        >
          <Image
      ...
      <div
        className={
          props.Type === "shorts" ? styles.shortsHead : styles.seriesHead
        }
      >
        {props.Title}
      </div>
      <div
        className={
          props.Type === "shorts" || props.Type === "videos"
            ? styles.displayNone
            : styles.seriesInfo
        }
      >
